...
export default function Footer() {
  return (
    <footer className="bg-linear-to-br from-red-950 to-stone-950 pt-16 pb-8 border-t border-amber-600/20">
      <div className="max-w-6xl mx-auto px-5 md:px-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
        {/* Brand */}
        <div>
          <div className="font-noto-serif-sc text-2xl text-amber-500 font-semibold tracking-[4px]">
            御膳楼
          </div>
        ...
        <div>
          ...
          <div className="flex gap-2.5 mb-3">
            <FaPhone className="text-amber-500 mt-1 flex-shrink-0 text-sm" />
            <a
          ...
          <div className="flex gap-2.5 mb-4">
            <FaMapMarkerAlt className="text-amber-500 mt-1 flex-shrink-0 text-sm" />
      ...
      <div className="max-w-6xl mx-auto px-5 md:px-10 pt-6 border-t border-amber-600/15 flex flex-col md:flex-row items-center justify-between gap-3">
        <span className="font-eb-garamond text-xs text-amber-50/35">
          © 2025 Empire Cuisine Restaurant (御膳楼). All Rights Reserved.
        </span>
        <span className="font-noto-serif-sc text-xs tracking-[3px] text-amber-500/25">
          御膳楼大酒家
        </span>
      </div>
    </footer>
